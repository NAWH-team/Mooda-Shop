...
const SignupB = () => {
  ...
  return (
    <div className="flex flex-col-1 gap-40">
      <img
      ...
      <div className="flex justify-center items-center lg:relative lg:left-[300px] top-20">
        <div className="bg-black h-[700px] w-[370px] lg:w-[527px] lg:h-[899px] bg-opacity-20 rounded-[10px]">
          <div className="flex flex-col m-8 float-left">
            ...
            <div className="relative top-24 right-10">
              ...
              <div className="m-8">
                ...
                <div className="">
                  ...
                  />
                  <div className="w-[250px]  h-[0px] border border-white border-opacity-50 relative"></div>
                </div>
              </div>
            ...
            <div className="m-8">
              ...
              <button
                ...
                className="float-right relative top-10 lg:relative lg:top-20 w-[175px] h-[47px] px-5 py-2.5 bg-gradient-to-bl from-purple-500 to-violet-700 rounded-[121px] justify-center items-center gap-2.5 inline-flex"
              >
